...
## Mechanism of Force via Exchange Particles
    - Particle A emits a field particle and Particle B absorbs it, resulting in a force between them.
...
### Important Points for Exams
- Dirac sea explains existence of antiparticles.
- Positron is first discovered antiparticle.
- Pair production requires minimum energy of $1.02\,\text{MeV}$.
- Annihilation produces two photons in opposite directions.
- Antiparticles have same mass and opposite charge.
