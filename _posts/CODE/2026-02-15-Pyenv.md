...
layout: post
title: "pyenv"
description: "A quick guide to using pyenv for managing multiple Python versions on macOS, with industry best practices for development."
date: 2026-02-15 11:00:00 +0530
categories: [SKMU, Code]
tags: [Python, pyenv, macOS, Development, Industry]
permalink: /pyenv/
---
...
---
## Getting Started with pyenv on macOS
...
Local (Project Specific – Industry Standard)
...
• python -m venv venv  
  → Creates a private isolated environment folder named `venv`.

• source venv/bin/activate  
  → Activates that isolated environment.
...
pyenv → Choose the engine version  
venv → Create a separate toolbox for that engine  

Together → Clean, scalable, production-ready development workflow.