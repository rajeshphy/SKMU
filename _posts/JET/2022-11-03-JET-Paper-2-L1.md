...
<div class="quiz-wrapper" style="display:flex;justify-content:center;margin-top:1.5rem;">
  <div id="quiz-container-wrapper"
    ...
    <div id="quiz-level-selector"
      ...
      <button class="level-btn" data-file="JET_Vector_Algebra_Easy.json">Easy</button>
      <button class="level-btn" data-file="JET_Vector_Algebra_Medium.json">Medium</button>
      <button class="level-btn" data-file="JET_Vector_Algebra_Hard.json">Hard</button>
    </div>
