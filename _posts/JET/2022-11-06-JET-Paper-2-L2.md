...
<div class="quiz-wrapper" style="display:flex;justify-content:center;margin-top:1.5rem;">
  <div id="quiz-container-wrapper"
       style="background:#ffffff;border-radius:0.8rem;box-shadow:0 2px 8px rgba(0,0,0,0.08);
              padding:1.2rem 1.5rem;max-width:560px;width:100%;font-family:'Inter',sans-serif;">

    <h2 style="text-align:center;color:#005edc;margin-bottom:0.8rem;
    ...
    <div id="quiz-level-selector"
      ...
      <button class="level-btn" data-file="JET_Vector_Calculus_Easy.json">Easy</button>
      <button class="level-btn" data-file="JET_Vector_Calculus_Medium.json">Medium</button>
      <button class="level-btn" data-file="JET_Vector_Calculus_Hard.json">Hard</button>
    </div>
